Module Ej4_13
    Sub main()
        ...
        Dim mejoralumno As New List(Of String)
        ...
        Dim notas As New List(Of Array)
        Dim promedios As New List(Of Single)
    ...
    Private Sub comprobarNota(ByRef notas As List(Of Array), ByRef cantidadnotas As Byte)
    ...
    Private Sub comprobarNombre(ByRef alumnos As List(Of String))
    ...
    Private Sub CalcularPromedios(ByVal notas As List(Of Array), ByVal alumnos As List(Of String), ByVal cantidadalumnos As Byte, ByVal cantidadnotas As Byte, ByRef promedios As List(Of Single))
        ...
        Next
    End Sub
    Private Function aprueba(ByVal prom As List(Of Single), ByRef i As Byte) As String
        If prom(i) >= 6 Then
            Return ("  Aprobo")
        Else
            Return ("  No aprobo")
        End If
    End Function
    Private Sub mejor(ByRef promedios As List(Of Single), ByRef alumnos As List(Of String), ByRef cantidadalumnos As Byte, ByRef cantidadnotas As Byte, ByRef mejoralumno As List(Of String))
